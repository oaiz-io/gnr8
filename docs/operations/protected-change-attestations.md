...
The checked-in exact-finding acceptance list deliberately trusts normal repository review and fails
when its graph delta becomes stale. It does not prove that a separately authorized reviewer approved
